...
void box2dInit()
{
  ...
  wall.add(new Box(width-148, height-580, 50, 25, true));
  wall.add(new Box(width-148, height-605, 50, 25, true));
  wall.add(new Box(width-148, height-630, 50, 25, true));
  wall.add(new Box(width-148, height-655, 50, 25, true));
  wall.add(new Box(width-148, height-680, 50, 25, true));
  ...
  wall.add(new Box(width-950, height-830, 50, 25, true));
  
  
  

  wall.add(new Box(width-1025, height-770, 50, 25, true));
